...
class TF_base:
    ...
    def __init__(self, logsdir):
        ...
        self.train_writer = tf.summary.FileWriter(logsdir+"/logs/train", graph=self._graph)
        self.test_writer = tf.summary.FileWriter(logsdir+"/logs/test", graph=self._graph)
